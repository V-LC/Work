...
# Form implementation generated from reading ui file 'id_amin.ui'
#
...
"")
        ...
        self.btn_msg_modify = QtWidgets.QPushButton(self.layoutWidget)
        self.btn_msg_modify.setStyleSheet("background-color: rgb(194, 170, 255,200);\n"
"")
        self.btn_msg_modify.setObjectName("btn_msg_modify")
        self.verticalLayout.addWidget(self.btn_msg_modify)
        self.btn_psw_modify = QtWidgets.QPushButton(self.layoutWidget)
        self.btn_psw_modify.setStyleSheet("background-color: rgb(194, 170, 255,200);\n"
"")
        self.btn_psw_modify.setObjectName("btn_psw_modify")
        self.verticalLayout.addWidget(self.btn_psw_modify)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "管理员账号管理"))
        self.btn_show.setText(_translate("Form", "账号显示"))
        self.btn_insert.setText(_translate("Form", "账号添加"))
        self.btn_delete.setText(_translate("Form", "账号注销"))
        self.btn_msg_modify.setText(_translate("Form", "信息修改"))
        self.btn_psw_modify.setText(_translate("Form", "密码修改"))
        self.btn_query.setText(_translate("Form", "账号查询"))
